...
/**
 * This is the action bar contributor for the Rif model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RifActionBarContributor extends EditingDomainActionBarContributor
	 ...
	 * @generated
	 */
	public RifActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("rif-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("rif-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				erafossmodelEditorPlugin.INSTANCE
						.getString("_UI_RifEditor_menu"), "era.foss.model.core.rifMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(erafossmodelEditorPlugin.INSTANCE
				.getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
