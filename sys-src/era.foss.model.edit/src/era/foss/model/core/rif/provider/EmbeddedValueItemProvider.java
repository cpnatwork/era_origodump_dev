...
/**
 * This is the item provider adapter for a {@link era.foss.model.core.rif.EmbeddedValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EmbeddedValueItemProvider extends ItemProviderAdapter implements
	...
	protected void addKEYPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_EmbeddedValue_kEY_feature", "_UI_EmbeddedValue_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						RifPackage.Literals.EMBEDDED_VALUE__KEY, true, false,
						false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
						null, null));
	}

	/**
	 * This adds a property descriptor for the OTHERCONTENT feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addOTHERCONTENTPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_EmbeddedValue_oTHERCONTENT_feature", "_UI_EmbeddedValue_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						RifPackage.Literals.EMBEDDED_VALUE__OTHERCONTENT, true,
						false, false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/EmbeddedValue")); //$NON-NLS-1$
	}
