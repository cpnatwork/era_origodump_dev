...
/**
 * This is the item provider adapter for a {@link era.foss.model.core.rif.Datatypes} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DatatypesItemProvider extends ItemProviderAdapter implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RifPackage.Literals.DATATYPES__GROUP);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/Datatypes")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		return getString("_UI_Datatypes_type"); //$NON-NLS-1$
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors
				.add(createChildParameter(
						RifPackage.Literals.DATATYPES__GROUP,
						FeatureMapUtil
								.createEntry(
				...
				.add(createChildParameter(
						...
						FeatureMapUtil
								.createEntry(
										...
										RifFactory.eINSTANCE
												.createDatatypeDefinitionDocument())));
				...
				.add(createChildParameter(
						...
						FeatureMapUtil
								.createEntry(
										...
										RifFactory.eINSTANCE
												.createDatatypeDefinitionXmlData())));
	}
