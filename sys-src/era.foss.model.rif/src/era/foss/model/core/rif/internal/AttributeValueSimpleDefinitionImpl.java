 ...
 * @generated
 */
public class AttributeValueSimpleDefinitionImpl extends EObjectImpl implements
	 ...
	 * @generated
	 */
	public void setATTRIBUTEDEFINITIONSIMPLEREF(
			String newATTRIBUTEDEFINITIONSIMPLEREF) {
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case RifPackage.ATTRIBUTE_VALUE_SIMPLE_DEFINITION__ATTRIBUTEDEFINITIONSIMPLEREF:
			return ATTRIBUTEDEFINITIONSIMPLEREF_EDEFAULT == null ? aTTRIBUTEDEFINITIONSIMPLEREF != null
					: !ATTRIBUTEDEFINITIONSIMPLEREF_EDEFAULT
							.equals(aTTRIBUTEDEFINITIONSIMPLEREF);
		}
	...
	public String toString() {
		...
		result.append(" (aTTRIBUTEDEFINITIONSIMPLEREF: "); //$NON-NLS-1$
