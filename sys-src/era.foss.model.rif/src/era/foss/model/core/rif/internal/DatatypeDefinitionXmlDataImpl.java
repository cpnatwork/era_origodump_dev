 ...
 * @generated
 */
public class DatatypeDefinitionXmlDataImpl extends EObjectImpl implements
	...
	public void setDESC(String newDESC) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.DATATYPE_DEFINITION_XML_DATA__DESC, oldDESC,
					dESC));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case RifPackage.DATATYPE_DEFINITION_XML_DATA__NAMESPACEURI:
			return NAMESPACEURI_EDEFAULT == null ? nAMESPACEURI != null
					: !NAMESPACEURI_EDEFAULT.equals(nAMESPACEURI);
		case RifPackage.DATATYPE_DEFINITION_XML_DATA__SCHEMALOCATION:
			return SCHEMALOCATION_EDEFAULT == null ? sCHEMALOCATION != null
