 ...
 * @generated
 */
public class DatatypeDefinitionDocumentImpl extends EObjectImpl implements
	 ...
	 * @ordered
	 */
	protected static final DATATYPEDEFINITIONDOCUMENTFORMATENUM FORMAT_EDEFAULT = DATATYPEDEFINITIONDOCUMENTFORMATENUM.XHTML;
	...
	public void setDESC(String newDESC) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.DATATYPE_DEFINITION_DOCUMENT__DESC, oldDESC,
					dESC));
	}
	...
	public void setFORMAT(DATATYPEDEFINITIONDOCUMENTFORMATENUM newFORMAT) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.DATATYPE_DEFINITION_DOCUMENT__FORMAT, oldFORMAT,
