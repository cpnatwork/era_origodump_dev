 ...
 * @generated
 */
public class AttributeValueEmbeddedDocumentXhtmlContentImpl extends EObjectImpl
		implements AttributeValueEmbeddedDocumentXhtmlContent {
	/**
	...
	public FeatureMap getAny() {
		if (any == null) {
			any = new BasicFeatureMap(
					this,
					RifPackage.ATTRIBUTE_VALUE_EMBEDDED_DOCUMENT_XHTML_CONTENT__ANY);
		}
		return any;
	}
