...
public class AccessPolicyImpl extends EObjectImpl implements AccessPolicy {
	...
	public void setLONGNAME(String newLONGNAME) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ACCESS_POLICY__LONGNAME, oldLONGNAME, lONGNAME));
	}
	...
	public void setDESC(String newDESC) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ACCESS_POLICY__DESC, oldDESC, dESC));
	}
	...
	public void setACCESSMODE(ACCESSPOLICYACCESSMODEENUM newACCESSMODE) {
		...
		aCCESSMODE = newACCESSMODE == null ? ACCESSMODE_EDEFAULT
				: newACCESSMODE;
		boolean oldACCESSMODEESet = (booleans & ACCESSMODE_ESETFLAG) != 0;
		booleans |= ACCESSMODE_ESETFLAG;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ACCESS_POLICY__ACCESSMODE, oldACCESSMODE,
					aCCESSMODE, !oldACCESSMODEESet));
	}
	...
	public void unsetACCESSMODE() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					RifPackage.ACCESS_POLICY__ACCESSMODE, oldACCESSMODE,
					ACCESSMODE_EDEFAULT, oldACCESSMODEESet));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetATTRIBUTEDEFINITIONS(
			AttributeDefinitions newATTRIBUTEDEFINITIONS, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					...
					oldATTRIBUTEDEFINITIONS, newATTRIBUTEDEFINITIONS);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setATTRIBUTEDEFINITIONS(
		...
		if (newATTRIBUTEDEFINITIONS != aTTRIBUTEDEFINITIONS) {
			...
			if (aTTRIBUTEDEFINITIONS != null)
				msgs = ((InternalEObject) aTTRIBUTEDEFINITIONS)
						.eInverseRemove(
								this,
			...
			if (newATTRIBUTEDEFINITIONS != null)
				msgs = ((InternalEObject) newATTRIBUTEDEFINITIONS)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- RifPackage.ACCESS_POLICY__ATTRIBUTEDEFINITIONS,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ACCESS_POLICY__ATTRIBUTEDEFINITIONS,
					newATTRIBUTEDEFINITIONS, newATTRIBUTEDEFINITIONS));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetATTRIBUTEVALUES(
			AttributeValues newATTRIBUTEVALUES, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					...
					oldATTRIBUTEVALUES, newATTRIBUTEVALUES);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setATTRIBUTEVALUES(AttributeValues newATTRIBUTEVALUES) {
		if (newATTRIBUTEVALUES != aTTRIBUTEVALUES) {
			...
			if (aTTRIBUTEVALUES != null)
				msgs = ((InternalEObject) aTTRIBUTEVALUES).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- RifPackage.ACCESS_POLICY__ATTRIBUTEVALUES,
						null, msgs);
			if (newATTRIBUTEVALUES != null)
				msgs = ((InternalEObject) newATTRIBUTEVALUES).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- RifPackage.ACCESS_POLICY__ATTRIBUTEVALUES,
						null, msgs);
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDATATYPEDEFINITIONS(
			DatatypeDefinitions newDATATYPEDEFINITIONS, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					...
					oldDATATYPEDEFINITIONS, newDATATYPEDEFINITIONS);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	 ...
	 * @generated
	 */
	public void setDATATYPEDEFINITIONS(
			DatatypeDefinitions newDATATYPEDEFINITIONS) {
		if (newDATATYPEDEFINITIONS != dATATYPEDEFINITIONS) {
			NotificationChain msgs = null;
			if (dATATYPEDEFINITIONS != null)
				msgs = ((InternalEObject) dATATYPEDEFINITIONS)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- RifPackage.ACCESS_POLICY__DATATYPEDEFINITIONS,
			...
			if (newDATATYPEDEFINITIONS != null)
				msgs = ((InternalEObject) newDATATYPEDEFINITIONS)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- RifPackage.ACCESS_POLICY__DATATYPEDEFINITIONS,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ACCESS_POLICY__DATATYPEDEFINITIONS,
					newDATATYPEDEFINITIONS, newDATATYPEDEFINITIONS));
	}
	...
	public void setIDENTIFIER(String newIDENTIFIER) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ACCESS_POLICY__IDENTIFIER, oldIDENTIFIER,
					iDENTIFIER));
	}
	...
	public void setLASTCHANGE(String newLASTCHANGE) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ACCESS_POLICY__LASTCHANGE, oldLASTCHANGE,
					lASTCHANGE));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRELATIONGROUPS(
			AccessPolicyRelationGroups newRELATIONGROUPS, NotificationChain msgs) {
		AccessPolicyRelationGroups oldRELATIONGROUPS = rELATIONGROUPS;
		rELATIONGROUPS = newRELATIONGROUPS;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, RifPackage.ACCESS_POLICY__RELATIONGROUPS,
					oldRELATIONGROUPS, newRELATIONGROUPS);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setRELATIONGROUPS(AccessPolicyRelationGroups newRELATIONGROUPS) {
		if (newRELATIONGROUPS != rELATIONGROUPS) {
			...
			if (rELATIONGROUPS != null)
				msgs = ((InternalEObject) rELATIONGROUPS).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- RifPackage.ACCESS_POLICY__RELATIONGROUPS,
						null, msgs);
			if (newRELATIONGROUPS != null)
				msgs = ((InternalEObject) newRELATIONGROUPS).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- RifPackage.ACCESS_POLICY__RELATIONGROUPS,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ACCESS_POLICY__RELATIONGROUPS,
					newRELATIONGROUPS, newRELATIONGROUPS));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSPECGROUPS(
			AccessPolicySpecGroups newSPECGROUPS, NotificationChain msgs) {
		AccessPolicySpecGroups oldSPECGROUPS = sPECGROUPS;
		sPECGROUPS = newSPECGROUPS;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, RifPackage.ACCESS_POLICY__SPECGROUPS,
					oldSPECGROUPS, newSPECGROUPS);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setSPECGROUPS(AccessPolicySpecGroups newSPECGROUPS) {
		if (newSPECGROUPS != sPECGROUPS) {
			NotificationChain msgs = null;
			if (sPECGROUPS != null)
				msgs = ((InternalEObject) sPECGROUPS).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- RifPackage.ACCESS_POLICY__SPECGROUPS, null,
						msgs);
			if (newSPECGROUPS != null)
				msgs = ((InternalEObject) newSPECGROUPS).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- RifPackage.ACCESS_POLICY__SPECGROUPS, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ACCESS_POLICY__SPECGROUPS, newSPECGROUPS,
					newSPECGROUPS));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSPECHIERARCHIES(
			SpecHierarchies newSPECHIERARCHIES, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					...
					oldSPECHIERARCHIES, newSPECHIERARCHIES);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setSPECHIERARCHIES(SpecHierarchies newSPECHIERARCHIES) {
		if (newSPECHIERARCHIES != sPECHIERARCHIES) {
			...
			if (sPECHIERARCHIES != null)
				msgs = ((InternalEObject) sPECHIERARCHIES).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- RifPackage.ACCESS_POLICY__SPECHIERARCHIES,
						null, msgs);
			if (newSPECHIERARCHIES != null)
				msgs = ((InternalEObject) newSPECHIERARCHIES).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- RifPackage.ACCESS_POLICY__SPECHIERARCHIES,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ACCESS_POLICY__SPECHIERARCHIES,
					newSPECHIERARCHIES, newSPECHIERARCHIES));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSPECHIERARCHYROOTS(
			AccessPolicySpecHierarchyRoots newSPECHIERARCHYROOTS,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					...
					oldSPECHIERARCHYROOTS, newSPECHIERARCHYROOTS);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	 ...
	 * @generated
	 */
	public void setSPECHIERARCHYROOTS(
			AccessPolicySpecHierarchyRoots newSPECHIERARCHYROOTS) {
		if (newSPECHIERARCHYROOTS != sPECHIERARCHYROOTS) {
			NotificationChain msgs = null;
			if (sPECHIERARCHYROOTS != null)
				msgs = ((InternalEObject) sPECHIERARCHYROOTS).eInverseRemove(
						this, EOPPOSITE_FEATURE_BASE
								- RifPackage.ACCESS_POLICY__SPECHIERARCHYROOTS,
						null, msgs);
			if (newSPECHIERARCHYROOTS != null)
				msgs = ((InternalEObject) newSPECHIERARCHYROOTS).eInverseAdd(
						this, EOPPOSITE_FEATURE_BASE
								- RifPackage.ACCESS_POLICY__SPECHIERARCHYROOTS,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ACCESS_POLICY__SPECHIERARCHYROOTS,
					newSPECHIERARCHYROOTS, newSPECHIERARCHYROOTS));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSPECOBJECTS(
			AccessPolicySpecObjects newSPECOBJECTS, NotificationChain msgs) {
		AccessPolicySpecObjects oldSPECOBJECTS = sPECOBJECTS;
		sPECOBJECTS = newSPECOBJECTS;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, RifPackage.ACCESS_POLICY__SPECOBJECTS,
					oldSPECOBJECTS, newSPECOBJECTS);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setSPECOBJECTS(AccessPolicySpecObjects newSPECOBJECTS) {
		if (newSPECOBJECTS != sPECOBJECTS) {
			NotificationChain msgs = null;
			if (sPECOBJECTS != null)
				msgs = ((InternalEObject) sPECOBJECTS).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- RifPackage.ACCESS_POLICY__SPECOBJECTS, null,
						msgs);
			if (newSPECOBJECTS != null)
				msgs = ((InternalEObject) newSPECOBJECTS).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- RifPackage.ACCESS_POLICY__SPECOBJECTS, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ACCESS_POLICY__SPECOBJECTS, newSPECOBJECTS,
					newSPECOBJECTS));
	}
	...
	public NotificationChain basicSetSPECRELATIONS(
			AccessPolicySpecRelations newSPECRELATIONS, NotificationChain msgs) {
		AccessPolicySpecRelations oldSPECRELATIONS = sPECRELATIONS;
		sPECRELATIONS = newSPECRELATIONS;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, RifPackage.ACCESS_POLICY__SPECRELATIONS,
	...
	public void setSPECRELATIONS(AccessPolicySpecRelations newSPECRELATIONS) {
		if (newSPECRELATIONS != sPECRELATIONS) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ACCESS_POLICY__SPECRELATIONS, newSPECRELATIONS,
					newSPECRELATIONS));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSPECTYPES(
			AccessPolicySpecTypes newSPECTYPES, NotificationChain msgs) {
		AccessPolicySpecTypes oldSPECTYPES = sPECTYPES;
		sPECTYPES = newSPECTYPES;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, RifPackage.ACCESS_POLICY__SPECTYPES,
					oldSPECTYPES, newSPECTYPES);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setSPECTYPES(AccessPolicySpecTypes newSPECTYPES) {
		if (newSPECTYPES != sPECTYPES) {
			NotificationChain msgs = null;
			if (sPECTYPES != null)
				msgs = ((InternalEObject) sPECTYPES).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- RifPackage.ACCESS_POLICY__SPECTYPES, null,
						msgs);
			if (newSPECTYPES != null)
				msgs = ((InternalEObject) newSPECTYPES).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- RifPackage.ACCESS_POLICY__SPECTYPES, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ACCESS_POLICY__SPECTYPES, newSPECTYPES,
					newSPECTYPES));
	}
	...
	public String toString() {
		...
		result.append(dESC);
		result.append(", aCCESSMODE: "); //$NON-NLS-1$
		if ((booleans & ACCESSMODE_ESETFLAG) != 0)
