...
public class SpecTypeImpl extends EObjectImpl implements SpecType {
	...
	public void setLONGNAME(String newLONGNAME) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.SPEC_TYPE__LONGNAME, oldLONGNAME, lONGNAME));
	}
	...
	public void setDESC(String newDESC) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.SPEC_TYPE__DESC, oldDESC, dESC));
	}
	...
	public void setIDENTIFIER(String newIDENTIFIER) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.SPEC_TYPE__IDENTIFIER, oldIDENTIFIER, iDENTIFIER));
	}
	...
	public void setLASTCHANGE(String newLASTCHANGE) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.SPEC_TYPE__LASTCHANGE, oldLASTCHANGE, lASTCHANGE));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSPECATTRIBUTES(
			SpecAttributes newSPECATTRIBUTES, NotificationChain msgs) {
		SpecAttributes oldSPECATTRIBUTES = sPECATTRIBUTES;
		sPECATTRIBUTES = newSPECATTRIBUTES;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, RifPackage.SPEC_TYPE__SPECATTRIBUTES,
	...
	public void setSPECATTRIBUTES(SpecAttributes newSPECATTRIBUTES) {
		if (newSPECATTRIBUTES != sPECATTRIBUTES) {
			...
			if (sPECATTRIBUTES != null)
				msgs = ((InternalEObject) sPECATTRIBUTES).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- RifPackage.SPEC_TYPE__SPECATTRIBUTES, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.SPEC_TYPE__SPECATTRIBUTES, newSPECATTRIBUTES,
					newSPECATTRIBUTES));
	}
	...
	public void setID(String newID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.SPEC_TYPE__ID, oldID, iD));
	}
