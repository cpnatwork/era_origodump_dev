 ...
 * @generated
 */
public class AttributeValueSimpleImpl extends EObjectImpl implements
	...
	public void setLONGNAME(String newLONGNAME) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ATTRIBUTE_VALUE_SIMPLE__LONGNAME, oldLONGNAME,
					lONGNAME));
	}
	...
	public void setDESC(String newDESC) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ATTRIBUTE_VALUE_SIMPLE__DESC, oldDESC, dESC));
	}
	...
	public NotificationChain basicSetDEFINITION(
			AttributeValueSimpleDefinition newDEFINITION, NotificationChain msgs) {
	...
	public void setTHEVALUE(String newTHEVALUE) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ATTRIBUTE_VALUE_SIMPLE__THEVALUE, oldTHEVALUE,
					tHEVALUE));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case RifPackage.ATTRIBUTE_VALUE_SIMPLE__THEVALUE:
			return THEVALUE_EDEFAULT == null ? tHEVALUE != null
					: !THEVALUE_EDEFAULT.equals(tHEVALUE);
		}
