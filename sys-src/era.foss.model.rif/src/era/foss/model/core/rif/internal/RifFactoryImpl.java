...
public class RifFactoryImpl extends EFactoryImpl implements RifFactory {
	...
	public static RifFactory init() {
		try {
			RifFactory theRifFactory = (RifFactory) EPackage.Registry.INSTANCE
					.getEFactory("http://automotive-his.de/schema/rif"); //$NON-NLS-1$ 
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		...
		case RifPackage.ACCESSPOLICYACCESSMODEENUM:
			return createACCESSPOLICYACCESSMODEENUMFromString(eDataType,
					initialValue);
		case RifPackage.BOOLEAN:
			return createBOOLEANFromString(eDataType, initialValue);
		case RifPackage.DATATYPEDEFINITIONDOCUMENTFORMATENUM:
			return createDATATYPEDEFINITIONDOCUMENTFORMATENUMFromString(
					eDataType, initialValue);
		case RifPackage.ACCESSPOLICYACCESSMODEENUM_OBJECT:
			return createACCESSPOLICYACCESSMODEENUMObjectFromString(eDataType,
					initialValue);
		...
		case RifPackage.DATATYPEDEFINITIONDOCUMENTFORMATENUM_OBJECT:
			return createDATATYPEDEFINITIONDOCUMENTFORMATENUMObjectFromString(
					eDataType, initialValue);
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
		case RifPackage.ACCESSPOLICYACCESSMODEENUM:
			return convertACCESSPOLICYACCESSMODEENUMToString(eDataType,
					instanceValue);
		case RifPackage.BOOLEAN:
			return convertBOOLEANToString(eDataType, instanceValue);
		case RifPackage.DATATYPEDEFINITIONDOCUMENTFORMATENUM:
			return convertDATATYPEDEFINITIONDOCUMENTFORMATENUMToString(
					eDataType, instanceValue);
		case RifPackage.ACCESSPOLICYACCESSMODEENUM_OBJECT:
			return convertACCESSPOLICYACCESSMODEENUMObjectToString(eDataType,
					instanceValue);
		case RifPackage.BOOLEAN_OBJECT:
			return convertBOOLEANObjectToString(eDataType, instanceValue);
		case RifPackage.DATATYPEDEFINITIONDOCUMENTFORMATENUM_OBJECT:
			return convertDATATYPEDEFINITIONDOCUMENTFORMATENUMObjectToString(
					eDataType, instanceValue);
		case RifPackage.FLOAT:
	 ...
	 * @generated
	 */
	public ACCESSPOLICYACCESSMODEENUM createACCESSPOLICYACCESSMODEENUMFromString(
			EDataType eDataType, String initialValue) {
		ACCESSPOLICYACCESSMODEENUM result = ACCESSPOLICYACCESSMODEENUM
				.get(initialValue);
		if (result == null)
			throw new IllegalArgumentException(
	 ...
	 * @generated
	 */
	public String convertACCESSPOLICYACCESSMODEENUMToString(
	 ...
	 * @generated
	 */
	public DATATYPEDEFINITIONDOCUMENTFORMATENUM createDATATYPEDEFINITIONDOCUMENTFORMATENUMFromString(
			EDataType eDataType, String initialValue) {
		DATATYPEDEFINITIONDOCUMENTFORMATENUM result = DATATYPEDEFINITIONDOCUMENTFORMATENUM
				.get(initialValue);
		if (result == null)
			throw new IllegalArgumentException(
					"The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	 ...
	 * @generated
	 */
	public String convertDATATYPEDEFINITIONDOCUMENTFORMATENUMToString(
			EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
	 ...
	 * @generated
	 */
	public ACCESSPOLICYACCESSMODEENUM createACCESSPOLICYACCESSMODEENUMObjectFromString(
			EDataType eDataType, String initialValue) {
		return createACCESSPOLICYACCESSMODEENUMFromString(
				RifPackage.Literals.ACCESSPOLICYACCESSMODEENUM, initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertACCESSPOLICYACCESSMODEENUMObjectToString(
			EDataType eDataType, Object instanceValue) {
		return convertACCESSPOLICYACCESSMODEENUMToString(
				RifPackage.Literals.ACCESSPOLICYACCESSMODEENUM, instanceValue);
	}
	...
	public BOOLEAN createBOOLEANObjectFromString(EDataType eDataType,
			String initialValue) {
		return createBOOLEANFromString(RifPackage.Literals.BOOLEAN,
				initialValue);
	}
	...
	public String convertBOOLEANObjectToString(EDataType eDataType,
			Object instanceValue) {
		return convertBOOLEANToString(RifPackage.Literals.BOOLEAN,
				instanceValue);
	}
	 ...
	 * @generated
	 */
	public DATATYPEDEFINITIONDOCUMENTFORMATENUM createDATATYPEDEFINITIONDOCUMENTFORMATENUMObjectFromString(
			EDataType eDataType, String initialValue) {
		return createDATATYPEDEFINITIONDOCUMENTFORMATENUMFromString(
				RifPackage.Literals.DATATYPEDEFINITIONDOCUMENTFORMATENUM,
				initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertDATATYPEDEFINITIONDOCUMENTFORMATENUMObjectToString(
			EDataType eDataType, Object instanceValue) {
		return convertDATATYPEDEFINITIONDOCUMENTFORMATENUMToString(
				RifPackage.Literals.DATATYPEDEFINITIONDOCUMENTFORMATENUM,
				instanceValue);
	...
	public Float createFLOATFromString(EDataType eDataType, String initialValue) {
		return (Float) XMLTypeFactory.eINSTANCE.createFromString(
	...
	public String convertFLOATToString(EDataType eDataType, Object instanceValue) {
		return XMLTypeFactory.eINSTANCE.convertToString(
				XMLTypePackage.Literals.FLOAT, instanceValue);
	}
