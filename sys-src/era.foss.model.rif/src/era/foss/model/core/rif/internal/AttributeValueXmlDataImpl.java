 ...
 * @generated
 */
public class AttributeValueXmlDataImpl extends EObjectImpl implements
	...
	public void setLONGNAME(String newLONGNAME) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ATTRIBUTE_VALUE_XML_DATA__LONGNAME, oldLONGNAME,
					lONGNAME));
	}
	...
	public void setDESC(String newDESC) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ATTRIBUTE_VALUE_XML_DATA__DESC, oldDESC, dESC));
	}
	...
	public NotificationChain basicSetDEFINITION(
			AttributeValueXmlDataDefinition newDEFINITION,
	...
	public NotificationChain basicSetXMLCONTENT(
			AttributeValueXmlDataXmlContent newXMLCONTENT,
			NotificationChain msgs) {
	...
	public void setXMLCONTENT(AttributeValueXmlDataXmlContent newXMLCONTENT) {
		if (newXMLCONTENT != xMLCONTENT) {
			NotificationChain msgs = null;
			if (xMLCONTENT != null)
				msgs = ((InternalEObject) xMLCONTENT)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- RifPackage.ATTRIBUTE_VALUE_XML_DATA__XMLCONTENT,
			...
			if (newXMLCONTENT != null)
				msgs = ((InternalEObject) newXMLCONTENT)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- RifPackage.ATTRIBUTE_VALUE_XML_DATA__XMLCONTENT,
