 ...
 * @generated
 */
public class DatatypeDefinitionRealImpl extends EObjectImpl implements
	...
	public void setLONGNAME(String newLONGNAME) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.DATATYPE_DEFINITION_REAL__LONGNAME, oldLONGNAME,
					lONGNAME));
	}
	...
	public void setDESC(String newDESC) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.DATATYPE_DEFINITION_REAL__DESC, oldDESC, dESC));
	}
	...
	public void setACCURACY(BigInteger newACCURACY) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.DATATYPE_DEFINITION_REAL__ACCURACY, oldACCURACY,
					aCCURACY));
	}
	...
	public void setMAX(float newMAX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.DATATYPE_DEFINITION_REAL__MAX, oldMAX, mAX,
					!oldMAXESet));
	}
	...
	public void unsetMAX() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					RifPackage.DATATYPE_DEFINITION_REAL__MAX, oldMAX,
	...
	public void setMIN(float newMIN) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.DATATYPE_DEFINITION_REAL__MIN, oldMIN, mIN,
					!oldMINESet));
	}
	...
	public void unsetMIN() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					RifPackage.DATATYPE_DEFINITION_REAL__MIN, oldMIN,
	...
	public String toString() {
		...
		if ((booleans & MAX_ESETFLAG) != 0)
			result.append(mAX);
		else
			result.append("<unset>"); //$NON-NLS-1$
		result.append(", mIN: "); //$NON-NLS-1$
		if ((booleans & MIN_ESETFLAG) != 0)
			result.append(mIN);
		else
			result.append("<unset>"); //$NON-NLS-1$
		result.append(')');
