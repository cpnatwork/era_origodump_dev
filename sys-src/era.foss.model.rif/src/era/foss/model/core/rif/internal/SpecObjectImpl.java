...
public class SpecObjectImpl extends EObjectImpl implements SpecObject {
	...
	public void setLONGNAME(String newLONGNAME) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.SPEC_OBJECT__LONGNAME, oldLONGNAME, lONGNAME));
	}
	...
	public void setDESC(String newDESC) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.SPEC_OBJECT__DESC, oldDESC, dESC));
	}
	...
	public void setIDENTIFIER(String newIDENTIFIER) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.SPEC_OBJECT__IDENTIFIER, oldIDENTIFIER,
					iDENTIFIER));
	}
	...
	public void setLASTCHANGE(String newLASTCHANGE) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.SPEC_OBJECT__LASTCHANGE, oldLASTCHANGE,
					lASTCHANGE));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTYPE(SpecObjectType newTYPE,
			NotificationChain msgs) {
		SpecObjectType oldTYPE = tYPE;
		tYPE = newTYPE;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, RifPackage.SPEC_OBJECT__TYPE, oldTYPE,
					newTYPE);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newTYPE != tYPE) {
			...
			if (tYPE != null)
				msgs = ((InternalEObject) tYPE).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RifPackage.SPEC_OBJECT__TYPE,
						null, msgs);
			if (newTYPE != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.SPEC_OBJECT__TYPE, newTYPE, newTYPE));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetVALUES(SpecObjectValues newVALUES,
			NotificationChain msgs) {
		SpecObjectValues oldVALUES = vALUES;
		vALUES = newVALUES;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, RifPackage.SPEC_OBJECT__VALUES,
					oldVALUES, newVALUES);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setVALUES(SpecObjectValues newVALUES) {
		if (newVALUES != vALUES) {
			NotificationChain msgs = null;
			if (vALUES != null)
				msgs = ((InternalEObject) vALUES)
						.eInverseRemove(this, EOPPOSITE_FEATURE_BASE
								- RifPackage.SPEC_OBJECT__VALUES, null, msgs);
			if (newVALUES != null)
				msgs = ((InternalEObject) newVALUES)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.SPEC_OBJECT__VALUES, newVALUES, newVALUES));
	}
