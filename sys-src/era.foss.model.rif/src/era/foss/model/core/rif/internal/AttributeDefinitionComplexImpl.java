 ...
 * @generated
 */
public class AttributeDefinitionComplexImpl extends EObjectImpl implements
	...
	public void setDESC(String newDESC) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ATTRIBUTE_DEFINITION_COMPLEX__DESC, oldDESC,
					dESC));
	}
	...
	public NotificationChain basicSetDEFAULTVALUE(
			AttributeDefinitionComplexDefaultValue newDEFAULTVALUE,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDEFAULTVALUE2(
			DefaultValue2 newDEFAULTVALUE2, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					...
					oldDEFAULTVALUE2, newDEFAULTVALUE2);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setDEFAULTVALUE2(DefaultValue2 newDEFAULTVALUE2) {
		if (newDEFAULTVALUE2 != dEFAULTVALUE2) {
			...
			if (dEFAULTVALUE2 != null)
				msgs = ((InternalEObject) dEFAULTVALUE2)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- RifPackage.ATTRIBUTE_DEFINITION_COMPLEX__DEFAULTVALUE2,
								null, msgs);
			if (newDEFAULTVALUE2 != null)
				msgs = ((InternalEObject) newDEFAULTVALUE2)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- RifPackage.ATTRIBUTE_DEFINITION_COMPLEX__DEFAULTVALUE2,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ATTRIBUTE_DEFINITION_COMPLEX__DEFAULTVALUE2,
					newDEFAULTVALUE2, newDEFAULTVALUE2));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDEFAULTVALUE3(
			DefaultValue3 newDEFAULTVALUE3, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					...
					oldDEFAULTVALUE3, newDEFAULTVALUE3);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setDEFAULTVALUE3(DefaultValue3 newDEFAULTVALUE3) {
		if (newDEFAULTVALUE3 != dEFAULTVALUE3) {
			...
			if (dEFAULTVALUE3 != null)
				msgs = ((InternalEObject) dEFAULTVALUE3)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- RifPackage.ATTRIBUTE_DEFINITION_COMPLEX__DEFAULTVALUE3,
								null, msgs);
			if (newDEFAULTVALUE3 != null)
				msgs = ((InternalEObject) newDEFAULTVALUE3)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- RifPackage.ATTRIBUTE_DEFINITION_COMPLEX__DEFAULTVALUE3,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ATTRIBUTE_DEFINITION_COMPLEX__DEFAULTVALUE3,
					newDEFAULTVALUE3, newDEFAULTVALUE3));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDEFAULTVALUE4(
			DefaultValue4 newDEFAULTVALUE4, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					...
					oldDEFAULTVALUE4, newDEFAULTVALUE4);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setDEFAULTVALUE4(DefaultValue4 newDEFAULTVALUE4) {
		if (newDEFAULTVALUE4 != dEFAULTVALUE4) {
			...
			if (dEFAULTVALUE4 != null)
				msgs = ((InternalEObject) dEFAULTVALUE4)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- RifPackage.ATTRIBUTE_DEFINITION_COMPLEX__DEFAULTVALUE4,
								null, msgs);
			if (newDEFAULTVALUE4 != null)
				msgs = ((InternalEObject) newDEFAULTVALUE4)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- RifPackage.ATTRIBUTE_DEFINITION_COMPLEX__DEFAULTVALUE4,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ATTRIBUTE_DEFINITION_COMPLEX__DEFAULTVALUE4,
					newDEFAULTVALUE4, newDEFAULTVALUE4));
	}
	...
	public NotificationChain basicSetTYPE(
			AttributeDefinitionComplexType newTYPE, NotificationChain msgs) {
		AttributeDefinitionComplexType oldTYPE = tYPE;
		tYPE = newTYPE;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					RifPackage.ATTRIBUTE_DEFINITION_COMPLEX__TYPE, oldTYPE,
					newTYPE);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setTYPE(AttributeDefinitionComplexType newTYPE) {
		if (newTYPE != tYPE) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ATTRIBUTE_DEFINITION_COMPLEX__TYPE, newTYPE,
					newTYPE));
	}
