...
public class SpecGroupImpl extends EObjectImpl implements SpecGroup {
	...
	public void setLONGNAME(String newLONGNAME) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.SPEC_GROUP__LONGNAME, oldLONGNAME, lONGNAME));
	}
	...
	public void setDESC(String newDESC) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.SPEC_GROUP__DESC, oldDESC, dESC));
	}
	...
	public void setIDENTIFIER(String newIDENTIFIER) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.SPEC_GROUP__IDENTIFIER, oldIDENTIFIER,
					iDENTIFIER));
	}
	...
	public void setLASTCHANGE(String newLASTCHANGE) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.SPEC_GROUP__LASTCHANGE, oldLASTCHANGE,
					lASTCHANGE));
	}
	...
	public NotificationChain basicSetRELATIONGROUPS(
			SpecGroupRelationGroups newRELATIONGROUPS, NotificationChain msgs) {
		SpecGroupRelationGroups oldRELATIONGROUPS = rELATIONGROUPS;
		rELATIONGROUPS = newRELATIONGROUPS;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, RifPackage.SPEC_GROUP__RELATIONGROUPS,
	...
	public void setRELATIONGROUPS(SpecGroupRelationGroups newRELATIONGROUPS) {
		if (newRELATIONGROUPS != rELATIONGROUPS) {
			...
			if (rELATIONGROUPS != null)
				msgs = ((InternalEObject) rELATIONGROUPS).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- RifPackage.SPEC_GROUP__RELATIONGROUPS, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.SPEC_GROUP__RELATIONGROUPS, newRELATIONGROUPS,
					newRELATIONGROUPS));
	}
	...
	public NotificationChain basicSetSPECOBJECTS(
			SpecGroupSpecObjects newSPECOBJECTS, NotificationChain msgs) {
		SpecGroupSpecObjects oldSPECOBJECTS = sPECOBJECTS;
		sPECOBJECTS = newSPECOBJECTS;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, RifPackage.SPEC_GROUP__SPECOBJECTS,
		...
		if (newSPECOBJECTS != sPECOBJECTS) {
			...
			if (sPECOBJECTS != null)
				msgs = ((InternalEObject) sPECOBJECTS).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- RifPackage.SPEC_GROUP__SPECOBJECTS, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.SPEC_GROUP__SPECOBJECTS, newSPECOBJECTS,
					newSPECOBJECTS));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTYPE(SpecGroupType newTYPE,
			NotificationChain msgs) {
		SpecGroupType oldTYPE = tYPE;
		tYPE = newTYPE;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, RifPackage.SPEC_GROUP__TYPE, oldTYPE,
					newTYPE);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newTYPE != tYPE) {
			...
			if (tYPE != null)
				msgs = ((InternalEObject) tYPE).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RifPackage.SPEC_GROUP__TYPE,
						null, msgs);
			if (newTYPE != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.SPEC_GROUP__TYPE, newTYPE, newTYPE));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetVALUES(SpecGroupValues newVALUES,
			NotificationChain msgs) {
		SpecGroupValues oldVALUES = vALUES;
		vALUES = newVALUES;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, RifPackage.SPEC_GROUP__VALUES, oldVALUES,
					newVALUES);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newVALUES != vALUES) {
			...
			if (vALUES != null)
				msgs = ((InternalEObject) vALUES).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RifPackage.SPEC_GROUP__VALUES,
						null, msgs);
			if (newVALUES != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.SPEC_GROUP__VALUES, newVALUES, newVALUES));
	}
