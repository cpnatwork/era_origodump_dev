...
public interface RifPackage extends EPackage {
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference ATTRIBUTE_DEFINITION__TYPE = eINSTANCE
				.getAttributeDefinition_Type();
		/**
		 ...
		 * @generated
		 */
		EClass SPEC_ELEMENT_WITH_USER_DEFINED_ATTRIBUTES = eINSTANCE
				.getSpecElementWithUserDefinedAttributes();
		/**
		 ...
		 * @generated
		 */
		EReference SPEC_TYPE__SPEC_ATTRIBUTES = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute ATTRIBUTE_VALUE_SIMPLE__THE_VALUE = eINSTANCE
		 ...
		 * @generated
		 */
		EClass DATATYPE_DEFINITION_SIMPLE = eINSTANCE
				.getDatatypeDefinitionSimple();
		/**
		 ...
		 * @generated
		 */
		EAttribute IDENTIFIABLE__LONG_NAME = eINSTANCE
		 ...
		 * @generated
		 */
		EReference ATTRIBUTE_DEFINITION_SIMPLE__DEFAULT_VALUE = eINSTANCE
