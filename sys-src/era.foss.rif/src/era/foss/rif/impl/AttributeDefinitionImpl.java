 ...
 * @generated
 */
public abstract class AttributeDefinitionImpl extends IdentifiableImpl
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							RifPackage.ATTRIBUTE_DEFINITION__TYPE, oldType,
							type));
			}
		}
		return type;
	...
	public void setType(DatatypeDefinition newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ATTRIBUTE_DEFINITION__TYPE, oldType, type));
	}
