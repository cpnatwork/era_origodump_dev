 ...
 * <ul>
 *   <li>{@link era.foss.rif.impl.AttributeDefinitionSimpleImpl#getDefaultValue <em>Default Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AttributeDefinitionSimpleImpl extends AttributeDefinitionImpl
		implements AttributeDefinitionSimple {
	/**
	...
	public NotificationChain basicSetDefaultValue(
			AttributeValueSimple newDefaultValue, NotificationChain msgs) {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case RifPackage.ATTRIBUTE_DEFINITION_SIMPLE__DEFAULT_VALUE:
