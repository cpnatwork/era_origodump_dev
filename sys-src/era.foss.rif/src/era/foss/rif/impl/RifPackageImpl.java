...
public class RifPackageImpl extends EPackageImpl implements RifPackage {
	...
	public static RifPackage init() {
		...
		RifPackageImpl theRifPackage = (RifPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof RifPackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI)
				: new RifPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEClass(rifEClass, era.foss.rif.RIF.class, "RIF", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRIF_CoreContent(), this.getRIFContent(), null,
				"coreContent", null, 1, 1, era.foss.rif.RIF.class,
		...
		initEAttribute(getDatatypeDefinitionInteger_Max(), ecorePackage
				.getEInt(), "max", null, 1, 1, DatatypeDefinitionInteger.class,
		...
		initEAttribute(getIdentifiable_Desc(), ecorePackage.getEString(),
				"desc", null, 0, 1, Identifiable.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getIdentifiable_LongName(), ecorePackage.getEString(),
				"longName", null, 0, 1, Identifiable.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
