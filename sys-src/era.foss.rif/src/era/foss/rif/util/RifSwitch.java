...
public class RifSwitch<T2> {
	...
	protected T2 doSwitch(int classifierID, EObject theEObject) {
		...
		case RifPackage.ATTRIBUTE_VALUE: {
			...
			if (result == null)
				result = caseIdentifiable(attributeValue);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case RifPackage.SPEC_ELEMENT_WITH_USER_DEFINED_ATTRIBUTES: {
			...
			if (result == null)
				result = caseIdentifiable(specElementWithUserDefinedAttributes);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case RifPackage.SPEC_OBJECT: {
			...
			if (result == null)
				result = caseSpecElementWithUserDefinedAttributes(specObject);
			if (result == null)
		...
		case RifPackage.ATTRIBUTE_VALUE_SIMPLE: {
			...
			if (result == null)
				result = caseIdentifiable(attributeValueSimple);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T2 caseSpecElementWithUserDefinedAttributes(
