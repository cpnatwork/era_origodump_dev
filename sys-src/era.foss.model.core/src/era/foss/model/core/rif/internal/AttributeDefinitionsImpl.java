 ...
 * @generated
 */
public class AttributeDefinitionsImpl extends EObjectImpl implements
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this,
					RifPackage.ATTRIBUTE_DEFINITIONS__GROUP);
		}
		return group;
	}
	 ...
	 * @generated
	 */
	public EList<String> getATTRIBUTEDEFINITIONCOMPLEXREF() {
		return getGroup()
				.list(
	 ...
	 * @generated
	 */
	public EList<String> getATTRIBUTEDEFINITIONSIMPLEREF() {
		return getGroup()
				.list(
	...
	public void eSet(int featureID, Object newValue) {
		...
		case RifPackage.ATTRIBUTE_DEFINITIONS__ATTRIBUTEDEFINITIONCOMPLEXREF:
			...
			getATTRIBUTEDEFINITIONCOMPLEXREF().addAll(
					(Collection<? extends String>) newValue);
			return;
		case RifPackage.ATTRIBUTE_DEFINITIONS__ATTRIBUTEDEFINITIONENUMERATIONREF:
			getATTRIBUTEDEFINITIONENUMERATIONREF().clear();
			getATTRIBUTEDEFINITIONENUMERATIONREF().addAll(
					(Collection<? extends String>) newValue);
			return;
		case RifPackage.ATTRIBUTE_DEFINITIONS__ATTRIBUTEDEFINITIONSIMPLEREF:
			getATTRIBUTEDEFINITIONSIMPLEREF().clear();
			getATTRIBUTEDEFINITIONSIMPLEREF().addAll(
					(Collection<? extends String>) newValue);
			return;
		}
