 ...
 * @generated
 */
public class SpecRelationValuesImpl extends EObjectImpl implements SpecRelationValues {
    /**
    ...
    public FeatureMap getGroup() {
        if( group == null ) {
            group = new BasicFeatureMap( this, RifPackage.SPEC_RELATION_VALUES__GROUP );
        }
        return group;
    }
    ...
    public EList getATTRIBUTEVALUEEMBEDDEDDOCUMENT() {
        return getGroup().list( RifPackage.Literals.SPEC_RELATION_VALUES__ATTRIBUTEVALUEEMBEDDEDDOCUMENT );
    }
    ...
    public EList getATTRIBUTEVALUEEMBEDDEDFILE() {
        return getGroup().list( RifPackage.Literals.SPEC_RELATION_VALUES__ATTRIBUTEVALUEEMBEDDEDFILE );
    }
    ...
    public EList getATTRIBUTEVALUEENUMERATION() {
        return getGroup().list( RifPackage.Literals.SPEC_RELATION_VALUES__ATTRIBUTEVALUEENUMERATION );
    }
    ...
    public EList getATTRIBUTEVALUEFILEREFERENCE() {
        return getGroup().list( RifPackage.Literals.SPEC_RELATION_VALUES__ATTRIBUTEVALUEFILEREFERENCE );
    }
    ...
    public EList getATTRIBUTEVALUESIMPLE() {
        return getGroup().list( RifPackage.Literals.SPEC_RELATION_VALUES__ATTRIBUTEVALUESIMPLE );
    }
    ...
    public EList getATTRIBUTEVALUEXMLDATA() {
        return getGroup().list( RifPackage.Literals.SPEC_RELATION_VALUES__ATTRIBUTEVALUEXMLDATA );
    }
