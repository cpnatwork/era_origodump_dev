 ...
 * @generated
 */
public class AttributeDefinitionEnumerationTypeImpl extends EObjectImpl implements AttributeDefinitionEnumerationType {
    /**
    ...
    public boolean eIsSet( int featureID ) {
        switch (featureID) {
        case RifPackage.ATTRIBUTE_DEFINITION_ENUMERATION_TYPE__DATATYPEDEFINITIONENUMERATIONREF:
            return DATATYPEDEFINITIONENUMERATIONREF_EDEFAULT == null
                ? dATATYPEDEFINITIONENUMERATIONREF != null
