 ...
 * @generated
 */
public class AttributeDefinitionComplexTypeImpl extends EObjectImpl implements
	 ...
	 * @generated
	 */
	public void setDATATYPEDEFINITIONBINARYFILEREF(
			String newDATATYPEDEFINITIONBINARYFILEREF) {
	 ...
	 * @generated
	 */
	public void setDATATYPEDEFINITIONDOCUMENTREF(
			String newDATATYPEDEFINITIONDOCUMENTREF) {
	 ...
	 * @generated
	 */
	public void setDATATYPEDEFINITIONXMLDATAREF(
			String newDATATYPEDEFINITIONXMLDATAREF) {
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case RifPackage.ATTRIBUTE_DEFINITION_COMPLEX_TYPE__DATATYPEDEFINITIONBINARYFILEREF:
			return DATATYPEDEFINITIONBINARYFILEREF_EDEFAULT == null ? dATATYPEDEFINITIONBINARYFILEREF != null
					: !DATATYPEDEFINITIONBINARYFILEREF_EDEFAULT
							.equals(dATATYPEDEFINITIONBINARYFILEREF);
		case RifPackage.ATTRIBUTE_DEFINITION_COMPLEX_TYPE__DATATYPEDEFINITIONDOCUMENTREF:
			return DATATYPEDEFINITIONDOCUMENTREF_EDEFAULT == null ? dATATYPEDEFINITIONDOCUMENTREF != null
					: !DATATYPEDEFINITIONDOCUMENTREF_EDEFAULT
							.equals(dATATYPEDEFINITIONDOCUMENTREF);
		case RifPackage.ATTRIBUTE_DEFINITION_COMPLEX_TYPE__DATATYPEDEFINITIONXMLDATAREF:
			return DATATYPEDEFINITIONXMLDATAREF_EDEFAULT == null ? dATATYPEDEFINITIONXMLDATAREF != null
					: !DATATYPEDEFINITIONXMLDATAREF_EDEFAULT
							.equals(dATATYPEDEFINITIONXMLDATAREF);
		}
	...
	public String toString() {
		...
		result.append(" (dATATYPEDEFINITIONBINARYFILEREF: "); //$NON-NLS-1$
		result.append(dATATYPEDEFINITIONBINARYFILEREF);
		result.append(", dATATYPEDEFINITIONDOCUMENTREF: "); //$NON-NLS-1$
		result.append(dATATYPEDEFINITIONDOCUMENTREF);
		result.append(", dATATYPEDEFINITIONXMLDATAREF: "); //$NON-NLS-1$
