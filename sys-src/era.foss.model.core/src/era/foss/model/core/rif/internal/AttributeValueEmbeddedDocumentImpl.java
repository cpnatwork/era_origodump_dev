 ...
 * @generated
 */
public class AttributeValueEmbeddedDocumentImpl extends EObjectImpl implements
	...
	public NotificationChain basicSetDEFINITION(
			AttributeValueEmbeddedDocumentDefinition newDEFINITION,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetXHTMLCONTENT(
			AttributeValueEmbeddedDocumentXhtmlContent newXHTMLCONTENT,
			NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					...
					oldXHTMLCONTENT, newXHTMLCONTENT);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	 ...
	 * @generated
	 */
	public void setXHTMLCONTENT(
			AttributeValueEmbeddedDocumentXhtmlContent newXHTMLCONTENT) {
		if (newXHTMLCONTENT != xHTMLCONTENT) {
			NotificationChain msgs = null;
			if (xHTMLCONTENT != null)
				msgs = ((InternalEObject) xHTMLCONTENT)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- RifPackage.ATTRIBUTE_VALUE_EMBEDDED_DOCUMENT__XHTMLCONTENT,
			...
			if (newXHTMLCONTENT != null)
				msgs = ((InternalEObject) newXHTMLCONTENT)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- RifPackage.ATTRIBUTE_VALUE_EMBEDDED_DOCUMENT__XHTMLCONTENT,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ATTRIBUTE_VALUE_EMBEDDED_DOCUMENT__XHTMLCONTENT,
					newXHTMLCONTENT, newXHTMLCONTENT));
	}
