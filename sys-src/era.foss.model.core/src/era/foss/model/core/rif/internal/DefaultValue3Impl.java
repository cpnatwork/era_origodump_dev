...
public class DefaultValue3Impl extends EObjectImpl implements DefaultValue3 {
    ...
    public void setATTRIBUTEVALUEEMBEDDEDDOCUMENT( AttributeValueEmbeddedDocument newATTRIBUTEVALUEEMBEDDEDDOCUMENT ) {
        if( newATTRIBUTEVALUEEMBEDDEDDOCUMENT != aTTRIBUTEVALUEEMBEDDEDDOCUMENT ) {
            ...
            if( aTTRIBUTEVALUEEMBEDDEDDOCUMENT != null ) msgs = ((InternalEObject)aTTRIBUTEVALUEEMBEDDEDDOCUMENT).eInverseRemove( this,
                                                                                                                                  EOPPOSITE_FEATURE_BASE
                                                                                                                                      - RifPackage.DEFAULT_VALUE3__ATTRIBUTEVALUEEMBEDDEDDOCUMENT,
                                                                                                                                  null,
                                                                                                                                  msgs );
            if( newATTRIBUTEVALUEEMBEDDEDDOCUMENT != null ) msgs = ((InternalEObject)newATTRIBUTEVALUEEMBEDDEDDOCUMENT).eInverseAdd( this,
                                                                                                                                     EOPPOSITE_FEATURE_BASE
                                                                                                                                         - RifPackage.DEFAULT_VALUE3__ATTRIBUTEVALUEEMBEDDEDDOCUMENT,
                                                                                                                                     null,
                                                                                                                                     msgs );
