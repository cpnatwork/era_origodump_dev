 ...
 * @generated
 */
public class AttributeValueEnumerationImpl extends EObjectImpl implements
	...
	public void setDESC(String newDESC) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ATTRIBUTE_VALUE_ENUMERATION__DESC, oldDESC, dESC));
	}
	...
	public NotificationChain basicSetDEFINITION(
			AttributeValueEnumerationDefinition newDEFINITION,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetVALUES(
			AttributeValueEnumerationValues newVALUES, NotificationChain msgs) {
		AttributeValueEnumerationValues oldVALUES = vALUES;
		vALUES = newVALUES;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					RifPackage.ATTRIBUTE_VALUE_ENUMERATION__VALUES, oldVALUES,
					newVALUES);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setVALUES(AttributeValueEnumerationValues newVALUES) {
		if (newVALUES != vALUES) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.ATTRIBUTE_VALUE_ENUMERATION__VALUES, newVALUES,
					newVALUES));
	}
