...
public class AttributeValuesImpl extends EObjectImpl implements AttributeValues {
    ...
    public FeatureMap getGroup() {
        if( group == null ) {
            group = new BasicFeatureMap( this, RifPackage.ATTRIBUTE_VALUES__GROUP );
        }
        return group;
    }
     ...
     * @generated
     */
    public EList getATTRIBUTEVALUEEMBEDDEDDOCUMENTREF() {
        return getGroup().list( RifPackage.Literals.ATTRIBUTE_VALUES__ATTRIBUTEVALUEEMBEDDEDDOCUMENTREF );
    }
     ...
     * @generated
     */
    public EList getATTRIBUTEVALUEEMBEDDEDFILEREF() {
        return getGroup().list( RifPackage.Literals.ATTRIBUTE_VALUES__ATTRIBUTEVALUEEMBEDDEDFILEREF );
    }
     ...
     * @generated
     */
    public EList getATTRIBUTEVALUEENUMERATIONREF() {
        return getGroup().list( RifPackage.Literals.ATTRIBUTE_VALUES__ATTRIBUTEVALUEENUMERATIONREF );
    }
     ...
     * @generated
     */
    public EList getATTRIBUTEVALUEFILEREFERENCEREF() {
        return getGroup().list( RifPackage.Literals.ATTRIBUTE_VALUES__ATTRIBUTEVALUEFILEREFERENCEREF );
    }
     ...
     * @generated
     */
    public EList getATTRIBUTEVALUESIMPLEREF() {
        return getGroup().list( RifPackage.Literals.ATTRIBUTE_VALUES__ATTRIBUTEVALUESIMPLEREF );
    }
     ...
     * @generated
     */
    public EList getATTRIBUTEVALUEXMLDATAREF() {
        return getGroup().list( RifPackage.Literals.ATTRIBUTE_VALUES__ATTRIBUTEVALUEXMLDATAREF );
    }
    ...
    public void eSet( int featureID, Object newValue ) {
        ...
        case RifPackage.ATTRIBUTE_VALUES__ATTRIBUTEVALUEEMBEDDEDDOCUMENTREF:
            ...
            getATTRIBUTEVALUEEMBEDDEDDOCUMENTREF().addAll( (Collection)newValue );
            return;
        case RifPackage.ATTRIBUTE_VALUES__ATTRIBUTEVALUEEMBEDDEDFILEREF:
            getATTRIBUTEVALUEEMBEDDEDFILEREF().clear();
            getATTRIBUTEVALUEEMBEDDEDFILEREF().addAll( (Collection)newValue );
            return;
        case RifPackage.ATTRIBUTE_VALUES__ATTRIBUTEVALUEENUMERATIONREF:
            getATTRIBUTEVALUEENUMERATIONREF().clear();
            getATTRIBUTEVALUEENUMERATIONREF().addAll( (Collection)newValue );
            return;
        case RifPackage.ATTRIBUTE_VALUES__ATTRIBUTEVALUEFILEREFERENCEREF:
            getATTRIBUTEVALUEFILEREFERENCEREF().clear();
            getATTRIBUTEVALUEFILEREFERENCEREF().addAll( (Collection)newValue );
            return;
        case RifPackage.ATTRIBUTE_VALUES__ATTRIBUTEVALUESIMPLEREF:
            getATTRIBUTEVALUESIMPLEREF().clear();
            getATTRIBUTEVALUESIMPLEREF().addAll( (Collection)newValue );
            return;
        case RifPackage.ATTRIBUTE_VALUES__ATTRIBUTEVALUEXMLDATAREF:
            getATTRIBUTEVALUEXMLDATAREF().clear();
            getATTRIBUTEVALUEXMLDATAREF().addAll( (Collection)newValue );
            return;
        }
