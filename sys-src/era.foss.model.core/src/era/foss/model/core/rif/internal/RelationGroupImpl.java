...
public class RelationGroupImpl extends EObjectImpl implements RelationGroup {
    ...
    public void setLONGNAME( String newLONGNAME ) {
        ...
        if( eNotificationRequired() ) eNotify( new ENotificationImpl(
            this,
            Notification.SET,
            RifPackage.RELATION_GROUP__LONGNAME,
            oldLONGNAME,
            lONGNAME ) );
    }
    ...
    public void setDESC( String newDESC ) {
        ...
        if( eNotificationRequired() ) eNotify( new ENotificationImpl(
            this,
            Notification.SET,
            RifPackage.RELATION_GROUP__DESC,
            oldDESC,
            dESC ) );
    }
    ...
    public void setIDENTIFIER( String newIDENTIFIER ) {
        ...
        if( eNotificationRequired() ) eNotify( new ENotificationImpl(
            this,
            Notification.SET,
            RifPackage.RELATION_GROUP__IDENTIFIER,
            oldIDENTIFIER,
            iDENTIFIER ) );
    }
    ...
    public void setLASTCHANGE( String newLASTCHANGE ) {
        ...
        if( eNotificationRequired() ) eNotify( new ENotificationImpl(
            this,
            Notification.SET,
            RifPackage.RELATION_GROUP__LASTCHANGE,
            oldLASTCHANGE,
            lASTCHANGE ) );
    }
     ...
     * @generated
     */
    public NotificationChain basicSetRELATIONTYPE( RelationType newRELATIONTYPE, NotificationChain msgs ) {
    ...
    public void setRELATIONTYPE( RelationType newRELATIONTYPE ) {
        if( newRELATIONTYPE != rELATIONTYPE ) {
            ...
            if( rELATIONTYPE != null ) msgs = ((InternalEObject)rELATIONTYPE).eInverseRemove( this,
                                                                                              EOPPOSITE_FEATURE_BASE
                                                                                                  - RifPackage.RELATION_GROUP__RELATIONTYPE,
                                                                                              null,
                                                                                              msgs );
            if( newRELATIONTYPE != null ) msgs = ((InternalEObject)newRELATIONTYPE).eInverseAdd( this,
                                                                                                 EOPPOSITE_FEATURE_BASE
                                                                                                     - RifPackage.RELATION_GROUP__RELATIONTYPE,
                                                                                                 null,
                                                                                                 msgs );
     ...
     * @generated
     */
    public NotificationChain basicSetSPECRELATIONS( RelationGroupSpecRelations newSPECRELATIONS,
    ...
    public NotificationChain basicSetTARGETGROUP( TargetGroup newTARGETGROUP, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl(
                this,
                Notification.SET,
                RifPackage.RELATION_GROUP__TARGETGROUP,
                oldTARGETGROUP,
                newTARGETGROUP );
            if( msgs == null ) msgs = notification;
            else msgs.add( notification );
    ...
    public void setTARGETGROUP( TargetGroup newTARGETGROUP ) {
        if( newTARGETGROUP != tARGETGROUP ) {
            NotificationChain msgs = null;
            if( tARGETGROUP != null ) msgs = ((InternalEObject)tARGETGROUP).eInverseRemove( this,
                                                                                            EOPPOSITE_FEATURE_BASE
                                                                                                - RifPackage.RELATION_GROUP__TARGETGROUP,
                                                                                            null,
                                                                                            msgs );
            if( newTARGETGROUP != null ) msgs = ((InternalEObject)newTARGETGROUP).eInverseAdd( this,
                                                                                               EOPPOSITE_FEATURE_BASE
                                                                                                   - RifPackage.RELATION_GROUP__TARGETGROUP,
                                                                                               null,
                                                                                               msgs );
