...
public class SpecRelationImpl extends EObjectImpl implements SpecRelation {
    ...
    public void setLONGNAME( String newLONGNAME ) {
        ...
        if( eNotificationRequired() ) eNotify( new ENotificationImpl(
            this,
            Notification.SET,
            RifPackage.SPEC_RELATION__LONGNAME,
            oldLONGNAME,
            lONGNAME ) );
    }
    ...
    public void setDESC( String newDESC ) {
        ...
        if( eNotificationRequired() ) eNotify( new ENotificationImpl(
            this,
            Notification.SET,
            RifPackage.SPEC_RELATION__DESC,
            oldDESC,
            dESC ) );
    }
    ...
    public NotificationChain basicSetSOURCE( Source newSOURCE, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl(
                this,
                Notification.SET,
                RifPackage.SPEC_RELATION__SOURCE,
                oldSOURCE,
                newSOURCE );
    ...
    public void setSOURCE( Source newSOURCE ) {
        if( newSOURCE != sOURCE ) {
            ...
            if( sOURCE != null ) msgs = ((InternalEObject)sOURCE).eInverseRemove( this, EOPPOSITE_FEATURE_BASE
                - RifPackage.SPEC_RELATION__SOURCE, null, msgs );
            if( newSOURCE != null ) msgs = ((InternalEObject)newSOURCE).eInverseAdd( this, EOPPOSITE_FEATURE_BASE
                - RifPackage.SPEC_RELATION__SOURCE, null, msgs );
    ...
    public NotificationChain basicSetTARGET( Target newTARGET, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl(
                this,
                Notification.SET,
                RifPackage.SPEC_RELATION__TARGET,
                oldTARGET,
                newTARGET );
            if( msgs == null ) msgs = notification;
            else msgs.add( notification );
    ...
    public void setTARGET( Target newTARGET ) {
        if( newTARGET != tARGET ) {
            NotificationChain msgs = null;
            if( tARGET != null ) msgs = ((InternalEObject)tARGET).eInverseRemove( this, EOPPOSITE_FEATURE_BASE
                - RifPackage.SPEC_RELATION__TARGET, null, msgs );
            if( newTARGET != null ) msgs = ((InternalEObject)newTARGET).eInverseAdd( this, EOPPOSITE_FEATURE_BASE
                - RifPackage.SPEC_RELATION__TARGET, null, msgs );
    ...
    public void setIDENTIFIER( String newIDENTIFIER ) {
        ...
        if( eNotificationRequired() ) eNotify( new ENotificationImpl(
            this,
            Notification.SET,
            RifPackage.SPEC_RELATION__IDENTIFIER,
            oldIDENTIFIER,
            iDENTIFIER ) );
    }
    ...
    public void setLASTCHANGE( String newLASTCHANGE ) {
        ...
        if( eNotificationRequired() ) eNotify( new ENotificationImpl(
            this,
            Notification.SET,
            RifPackage.SPEC_RELATION__LASTCHANGE,
            oldLASTCHANGE,
            lASTCHANGE ) );
    }
     ...
     * @generated
     */
    public NotificationChain basicSetTYPE( SpecRelationType newTYPE, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl(
                this,
                Notification.SET,
                RifPackage.SPEC_RELATION__TYPE,
                oldTYPE,
                newTYPE );
            if( msgs == null ) msgs = notification;
            else msgs.add( notification );
     ...
     * @generated
     */
    public NotificationChain basicSetVALUES( SpecRelationValues newVALUES, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl(
                this,
                Notification.SET,
                RifPackage.SPEC_RELATION__VALUES,
                oldVALUES,
                newVALUES );
            if( msgs == null ) msgs = notification;
            else msgs.add( notification );
