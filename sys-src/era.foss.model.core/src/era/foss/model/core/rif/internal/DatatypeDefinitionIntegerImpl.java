 ...
 * @generated
 */
public class DatatypeDefinitionIntegerImpl extends EObjectImpl implements
	...
	public void setDESC(String newDESC) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.DATATYPE_DEFINITION_INTEGER__DESC, oldDESC, dESC));
	}
	...
	public void setMAX(BigInteger newMAX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.DATATYPE_DEFINITION_INTEGER__MAX, oldMAX, mAX));
	}
	...
	public void setMIN(BigInteger newMIN) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.DATATYPE_DEFINITION_INTEGER__MIN, oldMIN, mIN));
	}
