 ...
 * @generated
 */
public class AttributeDefinitionSimpleTypeImpl extends EObjectImpl implements AttributeDefinitionSimpleType {
    /**
    ...
    public void setDATATYPEDEFINITIONSTRINGREF( String newDATATYPEDEFINITIONSTRINGREF ) {
        ...
        if( eNotificationRequired() ) eNotify( new ENotificationImpl(
            ...
            oldDATATYPEDEFINITIONSTRINGREF,
    ...
    public boolean eIsSet( int featureID ) {
        switch (featureID) {
        case RifPackage.ATTRIBUTE_DEFINITION_SIMPLE_TYPE__DATATYPEDEFINITIONBOOLEANREF:
            return DATATYPEDEFINITIONBOOLEANREF_EDEFAULT == null
                ? dATATYPEDEFINITIONBOOLEANREF != null
                : !DATATYPEDEFINITIONBOOLEANREF_EDEFAULT.equals( dATATYPEDEFINITIONBOOLEANREF );
        case RifPackage.ATTRIBUTE_DEFINITION_SIMPLE_TYPE__DATATYPEDEFINITIONINTEGERREF:
            return DATATYPEDEFINITIONINTEGERREF_EDEFAULT == null
                ? dATATYPEDEFINITIONINTEGERREF != null
                : !DATATYPEDEFINITIONINTEGERREF_EDEFAULT.equals( dATATYPEDEFINITIONINTEGERREF );
        case RifPackage.ATTRIBUTE_DEFINITION_SIMPLE_TYPE__DATATYPEDEFINITIONREALREF:
            return DATATYPEDEFINITIONREALREF_EDEFAULT == null
                ? dATATYPEDEFINITIONREALREF != null
                : !DATATYPEDEFINITIONREALREF_EDEFAULT.equals( dATATYPEDEFINITIONREALREF );
        case RifPackage.ATTRIBUTE_DEFINITION_SIMPLE_TYPE__DATATYPEDEFINITIONSTRINGREF:
            return DATATYPEDEFINITIONSTRINGREF_EDEFAULT == null
                ? dATATYPEDEFINITIONSTRINGREF != null
                : !DATATYPEDEFINITIONSTRINGREF_EDEFAULT.equals( dATATYPEDEFINITIONSTRINGREF );
        }
