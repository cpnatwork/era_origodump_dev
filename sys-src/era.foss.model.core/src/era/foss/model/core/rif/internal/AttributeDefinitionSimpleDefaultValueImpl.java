 ...
 * @generated
 */
public class AttributeDefinitionSimpleDefaultValueImpl extends EObjectImpl implements
    ...
    public void setATTRIBUTEVALUESIMPLE( AttributeValueSimple newATTRIBUTEVALUESIMPLE ) {
        if( newATTRIBUTEVALUESIMPLE != aTTRIBUTEVALUESIMPLE ) {
            ...
            if( aTTRIBUTEVALUESIMPLE != null ) msgs = ((InternalEObject)aTTRIBUTEVALUESIMPLE).eInverseRemove( this,
                                                                                                              EOPPOSITE_FEATURE_BASE
                                                                                                                  - RifPackage.ATTRIBUTE_DEFINITION_SIMPLE_DEFAULT_VALUE__ATTRIBUTEVALUESIMPLE,
                                                                                                              null,
                                                                                                              msgs );
            if( newATTRIBUTEVALUESIMPLE != null ) msgs = ((InternalEObject)newATTRIBUTEVALUESIMPLE).eInverseAdd( this,
                                                                                                                 EOPPOSITE_FEATURE_BASE
                                                                                                                     - RifPackage.ATTRIBUTE_DEFINITION_SIMPLE_DEFAULT_VALUE__ATTRIBUTEVALUESIMPLE,
                                                                                                                 null,
                                                                                                                 msgs );
