...
public class AttributeValueEmbeddedFileImpl extends EObjectImpl implements AttributeValueEmbeddedFile {
    ...
    public void setDESC( String newDESC ) {
        ...
        if( eNotificationRequired() ) eNotify( new ENotificationImpl(
            this,
            Notification.SET,
            RifPackage.ATTRIBUTE_VALUE_EMBEDDED_FILE__DESC,
            oldDESC,
            dESC ) );
    }
     ...
     * @generated
     */
    public NotificationChain basicSetBINARYCONTENT( AttributeValueEmbeddedFileBinaryContent newBINARYCONTENT,
     ...
     * @generated
     */
    public void setBINARYCONTENT( AttributeValueEmbeddedFileBinaryContent newBINARYCONTENT ) {
        if( newBINARYCONTENT != bINARYCONTENT ) {
            NotificationChain msgs = null;
            if( bINARYCONTENT != null ) msgs = ((InternalEObject)bINARYCONTENT).eInverseRemove( this,
                                                                                                EOPPOSITE_FEATURE_BASE
                                                                                                    - RifPackage.ATTRIBUTE_VALUE_EMBEDDED_FILE__BINARYCONTENT,
                                                                                                null,
                                                                                                msgs );
            if( newBINARYCONTENT != null ) msgs = ((InternalEObject)newBINARYCONTENT).eInverseAdd( this,
                                                                                                   EOPPOSITE_FEATURE_BASE
                                                                                                       - RifPackage.ATTRIBUTE_VALUE_EMBEDDED_FILE__BINARYCONTENT,
                                                                                                   null,
                                                                                                   msgs );
     ...
     * @generated
     */
    public NotificationChain basicSetDEFINITION( AttributeValueEmbeddedFileDefinition newDEFINITION,
                                                 NotificationChain msgs ) {
