 ...
 * @generated
 */
public class DatatypeDefinitionEnumerationImpl extends EObjectImpl implements
	...
	public void setDESC(String newDESC) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.DATATYPE_DEFINITION_ENUMERATION__DESC, oldDESC,
					dESC));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSPECIFIEDVALUES(
			SpecifiedValues newSPECIFIEDVALUES, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					...
					oldSPECIFIEDVALUES, newSPECIFIEDVALUES);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setSPECIFIEDVALUES(SpecifiedValues newSPECIFIEDVALUES) {
		if (newSPECIFIEDVALUES != sPECIFIEDVALUES) {
			...
			if (sPECIFIEDVALUES != null)
				msgs = ((InternalEObject) sPECIFIEDVALUES)
						.eInverseRemove(
								this,
			...
			if (newSPECIFIEDVALUES != null)
				msgs = ((InternalEObject) newSPECIFIEDVALUES)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- RifPackage.DATATYPE_DEFINITION_ENUMERATION__SPECIFIEDVALUES,
			...
			eNotify(new ENotificationImpl(
					...
					Notification.SET,
					RifPackage.DATATYPE_DEFINITION_ENUMERATION__SPECIFIEDVALUES,
					newSPECIFIEDVALUES, newSPECIFIEDVALUES));
	}
