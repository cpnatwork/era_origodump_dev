...
public class PropertiesImpl extends EObjectImpl implements Properties {
    ...
    public NotificationChain basicSetEMBEDDEDVALUE( EmbeddedValue newEMBEDDEDVALUE, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl(
                this,
                Notification.SET,
                RifPackage.PROPERTIES__EMBEDDEDVALUE,
                oldEMBEDDEDVALUE,
                newEMBEDDEDVALUE );
    ...
    public void setEMBEDDEDVALUE( EmbeddedValue newEMBEDDEDVALUE ) {
        if( newEMBEDDEDVALUE != eMBEDDEDVALUE ) {
            ...
            if( eMBEDDEDVALUE != null ) msgs = ((InternalEObject)eMBEDDEDVALUE).eInverseRemove( this,
                                                                                                EOPPOSITE_FEATURE_BASE
                                                                                                    - RifPackage.PROPERTIES__EMBEDDEDVALUE,
                                                                                                null,
                                                                                                msgs );
            if( newEMBEDDEDVALUE != null ) msgs = ((InternalEObject)newEMBEDDEDVALUE).eInverseAdd( this,
                                                                                                   EOPPOSITE_FEATURE_BASE
                                                                                                       - RifPackage.PROPERTIES__EMBEDDEDVALUE,
                                                                                                   null,
                                                                                                   msgs );
