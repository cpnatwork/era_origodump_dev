 ...
 * @generated
 */
public class SpecHierarchyRootValuesImpl extends EObjectImpl implements
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this,
					RifPackage.SPEC_HIERARCHY_ROOT_VALUES__GROUP);
		}
		return group;
	}
	...
	public EList<AttributeValueEmbeddedDocument> getATTRIBUTEVALUEEMBEDDEDDOCUMENT() {
		return getGroup()
				.list(
						RifPackage.Literals.SPEC_HIERARCHY_ROOT_VALUES__ATTRIBUTEVALUEEMBEDDEDDOCUMENT);
	}
	...
	public EList<AttributeValueEmbeddedFile> getATTRIBUTEVALUEEMBEDDEDFILE() {
		return getGroup()
				.list(
						RifPackage.Literals.SPEC_HIERARCHY_ROOT_VALUES__ATTRIBUTEVALUEEMBEDDEDFILE);
	}
	...
	public EList<AttributeValueEnumeration> getATTRIBUTEVALUEENUMERATION() {
		return getGroup()
				.list(
						RifPackage.Literals.SPEC_HIERARCHY_ROOT_VALUES__ATTRIBUTEVALUEENUMERATION);
	}
	...
	public EList<AttributeValueFileReference> getATTRIBUTEVALUEFILEREFERENCE() {
		return getGroup()
				.list(
						RifPackage.Literals.SPEC_HIERARCHY_ROOT_VALUES__ATTRIBUTEVALUEFILEREFERENCE);
	}
	...
	public EList<AttributeValueSimple> getATTRIBUTEVALUESIMPLE() {
		return getGroup()
				.list(
						RifPackage.Literals.SPEC_HIERARCHY_ROOT_VALUES__ATTRIBUTEVALUESIMPLE);
	}
	...
	public EList<AttributeValueXmlData> getATTRIBUTEVALUEXMLDATA() {
		return getGroup()
				.list(
						RifPackage.Literals.SPEC_HIERARCHY_ROOT_VALUES__ATTRIBUTEVALUEXMLDATA);
	}
