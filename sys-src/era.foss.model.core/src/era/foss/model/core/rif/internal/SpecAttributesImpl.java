...
public class SpecAttributesImpl extends EObjectImpl implements SpecAttributes {
     ...
     * @generated
     */
    public EList getATTRIBUTEDEFINITIONCOMPLEX() {
        return getGroup().list( RifPackage.Literals.SPEC_ATTRIBUTES__ATTRIBUTEDEFINITIONCOMPLEX );
    }
     ...
     * @generated
     */
    public EList getATTRIBUTEDEFINITIONENUMERATION() {
        return getGroup().list( RifPackage.Literals.SPEC_ATTRIBUTES__ATTRIBUTEDEFINITIONENUMERATION );
    }
     ...
     * @generated
     */
    public EList getATTRIBUTEDEFINITIONSIMPLE() {
        return getGroup().list( RifPackage.Literals.SPEC_ATTRIBUTES__ATTRIBUTEDEFINITIONSIMPLE );
    }
    ...
    public void eSet( int featureID, Object newValue ) {
        ...
        case RifPackage.SPEC_ATTRIBUTES__ATTRIBUTEDEFINITIONCOMPLEX:
            ...
            getATTRIBUTEDEFINITIONCOMPLEX().addAll( (Collection)newValue );
            return;
        case RifPackage.SPEC_ATTRIBUTES__ATTRIBUTEDEFINITIONENUMERATION:
            getATTRIBUTEDEFINITIONENUMERATION().clear();
            getATTRIBUTEDEFINITIONENUMERATION().addAll( (Collection)newValue );
            return;
        case RifPackage.SPEC_ATTRIBUTES__ATTRIBUTEDEFINITIONSIMPLE:
            getATTRIBUTEDEFINITIONSIMPLE().clear();
            getATTRIBUTEDEFINITIONSIMPLE().addAll( (Collection)newValue );
            return;
        }
