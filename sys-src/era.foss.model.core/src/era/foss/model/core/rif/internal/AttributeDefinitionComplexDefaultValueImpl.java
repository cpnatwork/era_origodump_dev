 ...
 * @generated
 */
public class AttributeDefinitionComplexDefaultValueImpl extends EObjectImpl implements
    ...
    public void setATTRIBUTEVALUEXMLDATA( AttributeValueXmlData newATTRIBUTEVALUEXMLDATA ) {
        if( newATTRIBUTEVALUEXMLDATA != aTTRIBUTEVALUEXMLDATA ) {
            ...
            if( aTTRIBUTEVALUEXMLDATA != null ) msgs = ((InternalEObject)aTTRIBUTEVALUEXMLDATA).eInverseRemove( this,
                                                                                                                EOPPOSITE_FEATURE_BASE
                                                                                                                    - RifPackage.ATTRIBUTE_DEFINITION_COMPLEX_DEFAULT_VALUE__ATTRIBUTEVALUEXMLDATA,
                                                                                                                null,
                                                                                                                msgs );
            if( newATTRIBUTEVALUEXMLDATA != null ) msgs = ((InternalEObject)newATTRIBUTEVALUEXMLDATA).eInverseAdd( this,
                                                                                                                   EOPPOSITE_FEATURE_BASE
                                                                                                                       - RifPackage.ATTRIBUTE_DEFINITION_COMPLEX_DEFAULT_VALUE__ATTRIBUTEVALUEXMLDATA,
                                                                                                                   null,
                                                                                                                   msgs );
