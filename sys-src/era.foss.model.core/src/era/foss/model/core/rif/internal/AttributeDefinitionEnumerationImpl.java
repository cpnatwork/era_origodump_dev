...
public class AttributeDefinitionEnumerationImpl extends EObjectImpl implements AttributeDefinitionEnumeration {
     ...
     * @ordered
     */
    protected static final BOOLEAN MULTIVALUED_EDEFAULT = BOOLEAN.TRUE_LITERAL;
    ...
    public void setDESC( String newDESC ) {
        ...
        if( eNotificationRequired() ) eNotify( new ENotificationImpl(
            this,
            Notification.SET,
            RifPackage.ATTRIBUTE_DEFINITION_ENUMERATION__DESC,
            oldDESC,
            dESC ) );
    }
     ...
     * @generated
     */
    public NotificationChain basicSetDEFAULTVALUE( AttributeDefinitionEnumerationDefaultValue newDEFAULTVALUE,
     ...
     * @generated
     */
    public void setDEFAULTVALUE( AttributeDefinitionEnumerationDefaultValue newDEFAULTVALUE ) {
    ...
    public void setMULTIVALUED( BOOLEAN newMULTIVALUED ) {
        ...
        mULTIVALUED = newMULTIVALUED == null ? MULTIVALUED_EDEFAULT : newMULTIVALUED;
     ...
     * @generated
     */
    public NotificationChain basicSetTYPE( AttributeDefinitionEnumerationType newTYPE, NotificationChain msgs ) {
    ...
    public void setTYPE( AttributeDefinitionEnumerationType newTYPE ) {
        if( newTYPE != tYPE ) {
            ...
            if( tYPE != null ) msgs = ((InternalEObject)tYPE).eInverseRemove( this, EOPPOSITE_FEATURE_BASE
                - RifPackage.ATTRIBUTE_DEFINITION_ENUMERATION__TYPE, null, msgs );
    ...
    public String toString() {
        ...
        if( (booleans & MULTIVALUED_ESETFLAG) != 0 ) result.append( mULTIVALUED );
