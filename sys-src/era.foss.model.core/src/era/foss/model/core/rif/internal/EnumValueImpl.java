...
public class EnumValueImpl extends EObjectImpl implements EnumValue {
    ...
    public void setLONGNAME( String newLONGNAME ) {
        ...
        if( eNotificationRequired() ) eNotify( new ENotificationImpl(
            this,
            Notification.SET,
            RifPackage.ENUM_VALUE__LONGNAME,
            oldLONGNAME,
            lONGNAME ) );
    }
    ...
    public void setIDENTIFIER( String newIDENTIFIER ) {
        ...
        if( eNotificationRequired() ) eNotify( new ENotificationImpl(
            this,
            Notification.SET,
            RifPackage.ENUM_VALUE__IDENTIFIER,
            oldIDENTIFIER,
            iDENTIFIER ) );
    }
    ...
    public void setLASTCHANGE( String newLASTCHANGE ) {
        ...
        if( eNotificationRequired() ) eNotify( new ENotificationImpl(
            this,
            Notification.SET,
            RifPackage.ENUM_VALUE__LASTCHANGE,
            oldLASTCHANGE,
            lASTCHANGE ) );
    }
    ...
    public NotificationChain basicSetPROPERTIES( Properties newPROPERTIES, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl(
                this,
                Notification.SET,
                RifPackage.ENUM_VALUE__PROPERTIES,
                oldPROPERTIES,
                newPROPERTIES );
