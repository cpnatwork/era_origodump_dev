...
public class RifImpl extends EObjectImpl implements Rif {
	...
	public NotificationChain basicSetSPECHIERARCHYROOTS(
			RifSpecHierarchyRoots newSPECHIERARCHYROOTS, NotificationChain msgs) {
		RifSpecHierarchyRoots oldSPECHIERARCHYROOTS = sPECHIERARCHYROOTS;
		sPECHIERARCHYROOTS = newSPECHIERARCHYROOTS;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, RifPackage.RIF__SPECHIERARCHYROOTS,
	...
	public void setSPECHIERARCHYROOTS(
			RifSpecHierarchyRoots newSPECHIERARCHYROOTS) {
		if (newSPECHIERARCHYROOTS != sPECHIERARCHYROOTS) {
			...
			if (sPECHIERARCHYROOTS != null)
				msgs = ((InternalEObject) sPECHIERARCHYROOTS).eInverseRemove(
						this, EOPPOSITE_FEATURE_BASE
								- RifPackage.RIF__SPECHIERARCHYROOTS, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.RIF__SPECHIERARCHYROOTS, newSPECHIERARCHYROOTS,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetACCESSPOLICIES(
			AccessPolicies newACCESSPOLICIES, NotificationChain msgs) {
		AccessPolicies oldACCESSPOLICIES = aCCESSPOLICIES;
		aCCESSPOLICIES = newACCESSPOLICIES;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, RifPackage.RIF__ACCESSPOLICIES,
	...
	public void setACCESSPOLICIES(AccessPolicies newACCESSPOLICIES) {
		if (newACCESSPOLICIES != aCCESSPOLICIES) {
			...
			if (aCCESSPOLICIES != null)
				msgs = ((InternalEObject) aCCESSPOLICIES)
						.eInverseRemove(this, EOPPOSITE_FEATURE_BASE
								- RifPackage.RIF__ACCESSPOLICIES, null, msgs);
			if (newACCESSPOLICIES != null)
				msgs = ((InternalEObject) newACCESSPOLICIES)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.RIF__ACCESSPOLICIES, newACCESSPOLICIES,
					newACCESSPOLICIES));
	}
	...
	public void setAUTHOR(String newAUTHOR) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.RIF__AUTHOR, oldAUTHOR, aUTHOR));
	}
	...
	public void setCOMMENT(String newCOMMENT) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.RIF__COMMENT, oldCOMMENT, cOMMENT));
	}
	...
	public void setCOUNTRYCODE(String newCOUNTRYCODE) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.RIF__COUNTRYCODE, oldCOUNTRYCODE, cOUNTRYCODE));
	}
	...
	public void setCREATIONTIME(String newCREATIONTIME) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.RIF__CREATIONTIME, oldCREATIONTIME, cREATIONTIME));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDATATYPES(Datatypes newDATATYPES,
			NotificationChain msgs) {
		Datatypes oldDATATYPES = dATATYPES;
		dATATYPES = newDATATYPES;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, RifPackage.RIF__DATATYPES, oldDATATYPES,
					newDATATYPES);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setDATATYPES(Datatypes newDATATYPES) {
		if (newDATATYPES != dATATYPES) {
			NotificationChain msgs = null;
			if (dATATYPES != null)
				msgs = ((InternalEObject) dATATYPES).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RifPackage.RIF__DATATYPES,
						null, msgs);
			if (newDATATYPES != null)
				msgs = ((InternalEObject) newDATATYPES).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - RifPackage.RIF__DATATYPES,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.RIF__DATATYPES, newDATATYPES, newDATATYPES));
	}
	...
	public void setIDENTIFIER(String newIDENTIFIER) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.RIF__IDENTIFIER, oldIDENTIFIER, iDENTIFIER));
	}
	...
	public void setSOURCETOOLID(String newSOURCETOOLID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.RIF__SOURCETOOLID, oldSOURCETOOLID, sOURCETOOLID));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSPECGROUPS(RifSpecGroups newSPECGROUPS,
			NotificationChain msgs) {
		RifSpecGroups oldSPECGROUPS = sPECGROUPS;
		sPECGROUPS = newSPECGROUPS;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, RifPackage.RIF__SPECGROUPS,
		...
		if (newSPECGROUPS != sPECGROUPS) {
			...
			if (sPECGROUPS != null)
				msgs = ((InternalEObject) sPECGROUPS).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RifPackage.RIF__SPECGROUPS,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.RIF__SPECGROUPS, newSPECGROUPS, newSPECGROUPS));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSPECOBJECTS(RifSpecObjects newSPECOBJECTS,
			NotificationChain msgs) {
		RifSpecObjects oldSPECOBJECTS = sPECOBJECTS;
		sPECOBJECTS = newSPECOBJECTS;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, RifPackage.RIF__SPECOBJECTS,
		...
		if (newSPECOBJECTS != sPECOBJECTS) {
			...
			if (sPECOBJECTS != null)
				msgs = ((InternalEObject) sPECOBJECTS).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RifPackage.RIF__SPECOBJECTS,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.RIF__SPECOBJECTS, newSPECOBJECTS, newSPECOBJECTS));
	}
	...
	public NotificationChain basicSetSPECRELATIONS(
			RifSpecRelations newSPECRELATIONS, NotificationChain msgs) {
		RifSpecRelations oldSPECRELATIONS = sPECRELATIONS;
		sPECRELATIONS = newSPECRELATIONS;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, RifPackage.RIF__SPECRELATIONS,
		...
		if (newSPECRELATIONS != sPECRELATIONS) {
			...
			if (sPECRELATIONS != null)
				msgs = ((InternalEObject) sPECRELATIONS).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RifPackage.RIF__SPECRELATIONS,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.RIF__SPECRELATIONS, newSPECRELATIONS,
					newSPECRELATIONS));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSPECTYPES(RifSpecTypes newSPECTYPES,
			NotificationChain msgs) {
		RifSpecTypes oldSPECTYPES = sPECTYPES;
		sPECTYPES = newSPECTYPES;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, RifPackage.RIF__SPECTYPES, oldSPECTYPES,
					newSPECTYPES);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newSPECTYPES != sPECTYPES) {
			...
			if (sPECTYPES != null)
				msgs = ((InternalEObject) sPECTYPES).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RifPackage.RIF__SPECTYPES,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.RIF__SPECTYPES, newSPECTYPES, newSPECTYPES));
	}
	...
	public void setTITLE(String newTITLE) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.RIF__TITLE, oldTITLE, tITLE));
	}
	...
	public void setVERSION(String newVERSION) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RifPackage.RIF__VERSION, oldVERSION, vERSION));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case RifPackage.RIF__COUNTRYCODE:
			return COUNTRYCODE_EDEFAULT == null ? cOUNTRYCODE != null
					: !COUNTRYCODE_EDEFAULT.equals(cOUNTRYCODE);
		case RifPackage.RIF__CREATIONTIME:
			return CREATIONTIME_EDEFAULT == null ? cREATIONTIME != null
		...
		case RifPackage.RIF__SOURCETOOLID:
			return SOURCETOOLID_EDEFAULT == null ? sOURCETOOLID != null
	...
	public String toString() {
		...
		result.append(", cOUNTRYCODE: "); //$NON-NLS-1$
