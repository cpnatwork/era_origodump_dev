 ...
 * @generated
 */
public class AttributeDefinitionEnumerationDefaultValueImpl extends EObjectImpl implements
    ...
    public FeatureMap getGroup() {
        if( group == null ) {
            group = new BasicFeatureMap( this, RifPackage.ATTRIBUTE_DEFINITION_ENUMERATION_DEFAULT_VALUE__GROUP );
        }
        return group;
    }
    ...
    public EList getATTRIBUTEVALUEENUMERATION() {
        return getGroup().list( RifPackage.Literals.ATTRIBUTE_DEFINITION_ENUMERATION_DEFAULT_VALUE__ATTRIBUTEVALUEENUMERATION );
    }
