...
public class AttributeDefinitionSimpleImpl extends EObjectImpl implements AttributeDefinitionSimple {
    ...
    public void setDESC( String newDESC ) {
        ...
        if( eNotificationRequired() ) eNotify( new ENotificationImpl(
            this,
            Notification.SET,
            RifPackage.ATTRIBUTE_DEFINITION_SIMPLE__DESC,
            oldDESC,
            dESC ) );
    }
     ...
     * @generated
     */
    public NotificationChain basicSetDEFAULTVALUE( AttributeDefinitionSimpleDefaultValue newDEFAULTVALUE,
     ...
     * @generated
     */
    public void setDEFAULTVALUE( AttributeDefinitionSimpleDefaultValue newDEFAULTVALUE ) {
     ...
     * @generated
     */
    public NotificationChain basicSetTYPE( AttributeDefinitionSimpleType newTYPE, NotificationChain msgs ) {
    ...
    public void setTYPE( AttributeDefinitionSimpleType newTYPE ) {
        if( newTYPE != tYPE ) {
            ...
            if( tYPE != null ) msgs = ((InternalEObject)tYPE).eInverseRemove( this, EOPPOSITE_FEATURE_BASE
                - RifPackage.ATTRIBUTE_DEFINITION_SIMPLE__TYPE, null, msgs );
