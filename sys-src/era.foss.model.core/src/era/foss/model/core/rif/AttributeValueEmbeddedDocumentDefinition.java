...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Attribute Value Embedded Document Definition</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link era.foss.model.core.rif.AttributeValueEmbeddedDocumentDefinition#getATTRIBUTEDEFINITIONCOMPLEXREF <em>ATTRIBUTEDEFINITIONCOMPLEXREF</em>}</li>
 * </ul>
 * </p>
 *
 * @see era.foss.model.core.rif.RifPackage#getAttributeValueEmbeddedDocumentDefinition()
 * @model extendedMetaData="name='DEFINITION_._type' kind='elementOnly'"
 * @generated
 */
public interface AttributeValueEmbeddedDocumentDefinition extends EObject {
    /**
     ...
     * @see era.foss.model.core.rif.RifPackage#getAttributeValueEmbeddedDocumentDefinition_ATTRIBUTEDEFINITIONCOMPLEXREF()
    ...
    /**
     * Sets the value of the '{@link era.foss.model.core.rif.AttributeValueEmbeddedDocumentDefinition#getATTRIBUTEDEFINITIONCOMPLEXREF <em>ATTRIBUTEDEFINITIONCOMPLEXREF</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
