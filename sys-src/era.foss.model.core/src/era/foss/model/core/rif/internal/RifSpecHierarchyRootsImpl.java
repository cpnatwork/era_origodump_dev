 ...
 * @generated
 */
public class RifSpecHierarchyRootsImpl extends EObjectImpl implements RifSpecHierarchyRoots {
    /**
    ...
    public FeatureMap getGroup() {
        if( group == null ) {
            group = new BasicFeatureMap( this, RifPackage.RIF_SPEC_HIERARCHY_ROOTS__GROUP );
        }
        return group;
    }
     ...
     * @generated
     */
    public EList getSPECHIERARCHYROOT() {
        return getGroup().list( RifPackage.Literals.RIF_SPEC_HIERARCHY_ROOTS__SPECHIERARCHYROOT );
    }
    ...
    public void eSet( int featureID, Object newValue ) {
        ...
        case RifPackage.RIF_SPEC_HIERARCHY_ROOTS__SPECHIERARCHYROOT:
            ...
            getSPECHIERARCHYROOT().addAll( (Collection)newValue );
            return;
        }
