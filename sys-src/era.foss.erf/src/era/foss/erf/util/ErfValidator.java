...
public class ErfValidator extends EObjectValidator {
    ...
    public boolean validateAttributeValueSimple( AttributeValueSimple attributeValueSimple,
        ...
        if( result || diagnostics != null )
            result &= validate_EveryDataValueConforms( attributeValueSimple, diagnostics, context );
        if( result || diagnostics != null )
            result &= validate_EveryReferenceIsContained( attributeValueSimple, diagnostics, context );
        if( result || diagnostics != null )
            result &= validate_EveryProxyResolves( attributeValueSimple, diagnostics, context );
        if( result || diagnostics != null ) result &= validate_UniqueID( attributeValueSimple, diagnostics, context );
        if( result || diagnostics != null )
            result &= validate_EveryKeyUnique( attributeValueSimple, diagnostics, context );
        if( result || diagnostics != null )
            result &= validate_EveryMapEntryUnique( attributeValueSimple, diagnostics, context );
        if( result || diagnostics != null )
            result &= validateAttributeValueSimple_DatatypeDefinitionConstraints( attributeValueSimple,
                                                                                  diagnostics,
                                                                                  context );
        return result;
    }
    ...
    public boolean validateAttributeValueSimple_DatatypeDefinitionConstraints( AttributeValueSimple attributeValueSimple,
        ...
        if( errorMsgKey != null && diagnostics != null ) {
            if( diagnostics != null ) {
                diagnostics.add( createDiagnostic( Diagnostic.ERROR, DIAGNOSTIC_SOURCE, 0, errorMsgKey, substitutions
                        .toArray(), new Object[] { attributeValueSimple }, context ) );
            }
            return false;
        }
        return true;
    ...
    public boolean validateDatatypeDefinitionInteger( DatatypeDefinitionInteger datatypeDefinitionInteger,
        ...
        if( result || diagnostics != null )
            result &= validate_EveryDataValueConforms( datatypeDefinitionInteger, diagnostics, context );
        if( result || diagnostics != null )
            result &= validate_EveryReferenceIsContained( datatypeDefinitionInteger, diagnostics, context );
        if( result || diagnostics != null )
            result &= validate_EveryProxyResolves( datatypeDefinitionInteger, diagnostics, context );
        if( result || diagnostics != null )
            result &= validate_UniqueID( datatypeDefinitionInteger, diagnostics, context );
        if( result || diagnostics != null )
            result &= validate_EveryKeyUnique( datatypeDefinitionInteger, diagnostics, context );
        if( result || diagnostics != null )
            result &= validate_EveryMapEntryUnique( datatypeDefinitionInteger, diagnostics, context );
        if( result || diagnostics != null )
            result &= validateDatatypeDefinitionInteger_NonNegative( datatypeDefinitionInteger, diagnostics, context );
        if( result || diagnostics != null )
            result &= validateDatatypeDefinitionInteger_MaxGreaterThanMin( datatypeDefinitionInteger,
                                                                           diagnostics,
                                                                           context );
        return result;
    }
    ...
    public boolean validateDatatypeDefinitionInteger_MaxGreaterThanMin( DatatypeDefinitionInteger datatypeDefinitionInteger,
                                                                        DiagnosticChain diagnostics,
                                                                        Map<Object, Object> context ) {
        if( datatypeDefinitionInteger.isSetMax() && datatypeDefinitionInteger.isSetMin()
