...
public abstract class IdentifiableImpl extends EObjectImpl implements
	...
	public void setID(String newID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ErfPackage.IDENTIFIABLE__ID, oldID, iD, !oldIDESet));
	}
	...
	public void unsetID() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					ErfPackage.IDENTIFIABLE__ID, oldID, ID_EDEFAULT, oldIDESet));
	}
	...
	public void setDesc(String newDesc) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ErfPackage.IDENTIFIABLE__DESC, oldDesc, desc));
	}
	...
	public void setLongName(String newLongName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ErfPackage.IDENTIFIABLE__LONG_NAME, oldLongName, longName));
	}
